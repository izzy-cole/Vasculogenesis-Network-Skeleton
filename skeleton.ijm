...
//Default:
main_path = "C:/Users/isabe/Documents/work/systems bio/modelling vasculogenesis/imageJ/raw/main_local/";
save_path = "C:/Users/isabe/Documents/work/systems bio/modelling vasculogenesis/python/data/raw/main_local/";
csv_path = "C:/Users/isabe/Documents/work/systems bio/modelling vasculogenesis/python/data/imagej/imageJ_metadata_local.csv";
	...
	for (n = 1; n <= n_s.length; n++) {
		for (c = 0; c< conditions.length; c++) {
			...
			if (!low_contrast){
				...
				thin_vessel = getBoolean("Thin vessel mode? \n (recommended: for stages HH12 and HH13)");
				if (!thin_vessel){
				run("Auto Local Threshold", "method=Bernsen radius="+local_threshold_radius+" parameter_1=0 parameter_2=0 white");
				}
				else{
					run("Auto Local Threshold", "method=Bernsen radius="+local_threshold_radius/2+" parameter_1=0 parameter_2=0 white");
				}
			}
			...
			//Recommended not to remove white outliers, as this degrades the shape of larger blood islands. It's better to later filter them via "analyse particles"
